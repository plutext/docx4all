 ...
 */
public class RightLineBorderSegment extends LineBorderSegment {
	public RightLineBorderSegment(CTBorder border) {
		this(border.getColor(), border.getStyle(), border.getSizeInPixels());
	}
	
	public RightLineBorderSegment(Color c, Style style, int thickness) {
		super(c, Side.RIGHT, style, thickness);
	}
