 ...
 */
public class TopLineBorderSegment extends LineBorderSegment {
	public TopLineBorderSegment(CTBorder border) {
		this(border.getColor(), border.getStyle(), border.getSizeInPixels());
	}
	
	public TopLineBorderSegment(Color c, Style style, int thickness) {
		super(c, Side.TOP, style, thickness);
	}
